...
from constants import PHAZER_GUN1_DAMAGE, PLAYER_RADIUS, PLAYER_SHOOT_COOLDOWN, PLAYER_SHOOT_SPEED, PLAYER_SPEED, PLAYER_TURN_SPEED, SCREEN_WIDTH, SCREEN_HEIGHT 
...
class Game():
    def __init__(self, screen):
        ...
        phazer = Ship("Phaser", "resources/payton.png", PLAYER_RADIUS, PLAYER_SPEED, PLAYER_TURN_SPEED, PLAYER_SHOOT_SPEED, PLAYER_SHOOT_COOLDOWN, PHAZER_GUN1_DAMAGE, get_phazer_sprite())   
